...
namespace Trellcko.DefenseFromMonster.Core.Pool
{
    /// <summary>
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        [SerializeField]
        private List<PoolConfigObject> _pooledPrefabsList;

        private HashSet<GameObject> _prefabs = new HashSet<GameObject>();

        private Dictionary<GameObject, ObjectPool<NetworkObject>> _pooledObjects = new Dictionary<GameObject, ObjectPool<NetworkObject>>();
